...
from nnunet.network_architecture.HMRNet_p import HMRNet_p
from nnunet.network_architecture.HMRNet_s import HMRNet_s
...
class nnUNetTrainerV2(nnUNetTrainer):
    ...
    def initialize_network(self):
        ...
        params = {'in_chns':3,
              ...
              'do_ds':True, 
              'con_op':nn.Conv3d }
        print('net param',params)
        self.network = HMRNet_s(params)    
        self.print_to_log_file("############This net  is HMRNet_p\n" )
